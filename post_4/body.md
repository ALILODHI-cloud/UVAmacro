...
Figure 3 demonstrates the power of PCA, plotting PC2 component against the ACM measure of 10yr term premium. Increases in PC2 correspond to broad-based steepening in the curve, or simultaneous steepening amongst many segments of the curve. Also, presumably, the 10yr term premium correlates positively with the premium commanded by other tenors. Put together, these facts entail that increases in 10yr term premium should in most instances be accompanied by broad-based steepening in the curve, and thus increases in PC2. Similiar reasoning establishes that decreases in 10yr term premium should be accompanied by decreases in PC2. 

**Section 2: PCA-based decomposition of 10yr yield**

If the nominal 10yr treasury yield can be decomposed into a policy path-pricing and term premium component, then we can distinguish between (1) circumstances in which the term premium component is high for reasons that reflect  
