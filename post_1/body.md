...
Figure 2 shows a clear steepening of the 2s10s, relative to fair value, over the shaded sample (the average residual over this period is ~5 times the model standard error). Indeed, over that sample, the curve outperforms its beta to both the 1y1y swap rate and the MOVE index (Figure 3).
